...
CARD_DETAILS = (
    "💳 <b>Карта Т-Банк (СБП):</b>\n"
    "<code>2200 7017 3823 7798</code>\n\n"
    "<b>При невозможности оплате по карте, обратитесь в поддержду для оплаты по СБП<b>/n"
)
...
ROBUX_INSTANT = [
    ...
    ("rb_200", "200 робуксов", 269, "моментально"),
    ("rb_400", "400 робуксов", 439, "моментально"),
    ("rb_500", "500 робуксов", 459, "моментально"),
    ("rb_1000", "1000 робуксов", 879, "моментально"),
    ("rb_1700", "1700 робуксов", 1529, "моментально"),
